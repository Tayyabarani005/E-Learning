            ...
            className="container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
                    ...
                    <div className='space-y-4 max-w-[300px]'>
                        ...
                        <p>TCJ is a platform dedicated to empowering aspiring developers. From beginner tutorials to advanced programming concepts, we provide a comprehensive learning experience designed to help you master coding skills, build projects, and launch your tech career.</p>
                    </div>
                    {/* second section */}
                    ...
                    <div className='space-y-4 max-w-[300px]'>
                        ...
                        <div className='flex space-x-6 py-3'>
                            <a href="https://chat.whatsapp.com/FQSKgJSf1eIAhlyF5sVym0">
